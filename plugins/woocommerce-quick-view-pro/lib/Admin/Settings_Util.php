...
class Settings_Util {
	 ...
	 *
	 * @param Barn2\WQV_Lib\Plugin $plugin
		...
		$links = apply_filters(
			...
			[
				'doc'     => [
					...
					'label'  => __( 'Documentation', 'woocommerce-quick-view-pro' ),
					'target' => '_blank',
				],
				'support' => [
					'url'    => $plugin->get_support_url(),
					'label'  => __( 'Support', 'woocommerce-quick-view-pro' ),
					'target' => '_blank',
				],
			],
			$plugin
