...
if ( ! class_exists( 'Iconic_WQV_Settings_Framework' ) ) {
	/**
	 * Iconic_WQV_Settings_Framework class
	 */
	class Iconic_WQV_Settings_Framework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * Iconic_WQV_Settings_Framework constructor.
		 *
