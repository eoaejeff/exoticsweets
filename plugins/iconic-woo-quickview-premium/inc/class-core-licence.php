...
if ( class_exists( 'Iconic_WQV_Core_Licence' ) ) {
    return;
}
/**
 * Iconic_WQV_Core_Licence.
 *
...
class Iconic_WQV_Core_Licence
{
    ...
    public static function connect_before()
    {
        ...
        if ( class_exists( 'Iconic_WQV_Core_Settings' ) ) {
            Iconic_WQV_Core_Settings::$settings_framework->settings_header();
        }
    }
    ...
    {
        return $html . sprintf( '<a href="%s" class="button button-secondary">&larr; %s</a>', self::$args['urls']['settings'], esc_html__( 'Back to Settings', 'jckqv' ) );
    }
    ...
    {
        if ( !Iconic_WQV_Core_Settings::is_settings_page( '-account' ) ) {
            return;
        }
        ?>
    ...
    {
        $links[] = sprintf( '<a href="%s" target="_blank">%s</a>', self::$args['urls']['product'] . '/changelog/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=jckqv&utm_content=changelog-link', esc_html__( 'Changelog', 'jckqv' ) );
        return $links;
    }
    ...
    {
        return sprintf( '<a href="%s" class="button button-secondary">%s</a>', self::$args['urls']['account'], esc_html__( 'Manage Licence &amp; Billing', 'jckqv' ) );
    }
