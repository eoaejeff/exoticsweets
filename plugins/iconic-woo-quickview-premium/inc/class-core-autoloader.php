...
if ( class_exists( 'Iconic_WQV_Core_Autoloader' ) ) {
	return;
}

/**
 * Iconic_WQV_Core_Autoloader.
 *
 * @class    Iconic_WQV_Core_Autoloader
 * @version  1.0.1
 */
class Iconic_WQV_Core_Autoloader {
	/**
	 * Single instance of the Iconic_WQV_Core_Autoloader object.
	 *
	 * @var Iconic_WQV_Core_Autoloader
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_WQV_Core_Autoloader object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return Iconic_WQV_Core_Autoloader
	 */
