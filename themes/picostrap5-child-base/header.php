...
<html <?php language_attributes(); ?>>
	...
	<?php if(function_exists('lc_custom_header')) lc_custom_header(); else {
		...
		<div id="wrapper-topbar" class="py-2 <?php echo get_theme_mod('topbar_bg_color_choice','bg-light') ?> <?php echo get_theme_mod('topbar_text_color_choice','text-dark') ?>">
			<div class="container">
				<div class="row">
					<div id="topbar-content" class="col-12 text-center small"> <?php echo do_shortcode(get_theme_mod('topbar_content')) ?>	</div>
				</div>
			</div>
		</div>
		<?php endif; ?>
						...
						<div class="col-12 d-flex flex-row align-items-center justify-content-between">
							...
							<div class="nav-utilities">
								<div class="nav-search">
									<a href="" class="d-flex align-items-center text-decoration-none text-uppercase fw-bold text-secondary" data-bs-toggle="modal" data-bs-target="#searchModal">
										<svg xmlns="http://www.w3.org/2000/svg" width="24.001" height="24.001" viewBox="0 0 24.001 24.001" class="me-2">
								...
								<div class="nav-cart" >
									<a class="d-flex align-items-center text-decoration-none text-uppercase fw-bold text-secondary" data-bs-toggle="offcanvas" href="#cartDrawer" role="button" aria-controls="cartDrawer">
