...
require_once get_stylesheet_directory() . '/inc/woocommerce-loop-mods.php';
require_once get_stylesheet_directory() . '/inc/woocommerce-archive-mods.php';
require_once get_stylesheet_directory() . '/inc/woocommerce-single-product-mods.php';