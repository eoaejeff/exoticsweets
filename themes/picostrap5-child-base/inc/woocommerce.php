...
// Display WooCommerce Wrapper for anything that isn't a Product
add_action( 'woocommerce_before_shop_loop', 'picostrap_woocommerce_wrapper_start', 10 );
add_action( 'woocommerce_after_main_content', 'picostrap_woocommerce_wrapper_end', 10 );
// Display WooCommerce Wrapper for Single Product
add_action( 'woocommerce_before_main_content', 'picostrap_woocommerce_single_wrapper_start', 10 );
...
if ( ! function_exists( 'picostrap_woocommerce_single_wrapper_start' ) ) {
...
if ( ! function_exists( 'picostrap_woocommerce_wrapper_end' ) ) {
	function picostrap_woocommerce_wrapper_end() {
		...
		echo '</div> ';
		echo '</div> ';
		echo '</section><!-- WooCommerce Wrapper end -->';
	}
