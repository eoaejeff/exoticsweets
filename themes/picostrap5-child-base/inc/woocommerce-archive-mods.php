...
function picostrap_archive_header_wrap_start() {
	...
	if ( ! is_product() ){
		echo '<section class="pt-5" id="woo-archive-header">';
		echo '<div class="container">';
		echo '<div class="row">';
		echo '<div class="col col-md-10 mx-4 mx-md-auto p-4 pt-5 p-lg-5 mt-5 bg-white shadow border-top border-secondary border-5 position-relative woo-archive-description">';
	} else {
